...
export function EnvTokenClient() {
	return (
		<Info>
			<p>
				In development,&nbsp;<code>TIVET_TOKEN</code> will use the
				development token generated by <code>tivet run</code>. In
				production,&nbsp;<code>TIVET_TOKEN</code> will be automatically
				added by the CDN.
			</p>
	...
	return (
		<Info>
			<p>
				In development, <code>TIVET_TOKEN</code> will use the
				development token generated by <code>tivet run</code>. In
				production,&nbsp;<code>TIVET_TOKEN</code> is automatically added
				to your environment by Tivet.
			</p>
...
export function PreTivetBranch() {
	return (
		<Info>
			<p>
				The <code>pre-tivet</code> branch contains the source code of
				this project without Tivet implemented, in contrast to the{" "}
				<code>main</code> branch. View these side by side to get a good
				picture of what it takes to integrate Tivet for your game.
			</p>
		</Info>
	);
}
...
export function InstallCli() {
	return (
		<Note>
			Make sure you have installed the Tivet CLI{" "}
			<Link
				href="https://github.com/tivet-gg/cli#installing"
				target="_blank"
			>
				here
			</Link>
