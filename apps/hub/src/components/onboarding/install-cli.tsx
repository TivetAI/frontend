import { CodeFrame, CodeGroup, CodeSource } from "@tivet-gg/components";
import installCliCmd, {
	source as installCliCmdSource,
} from "./initial-setup-install-tivet-cli-cmd.sh?shiki&lang=bash";
import installCliPowerShell, {
	source as installCliPowerShellSource,
} from "./initial-setup-install-tivet-cli-powershell.sh?shiki&lang=bash";
import installCliSource, {
	source as installCliSourceSource,
} from "./initial-setup-install-tivet-cli-source.sh?shiki&lang=bash";
import installCliUnix, {
	source as installCliUnixSource,
} from "./initial-setup-install-tivet-cli-unix.sh?shiki&lang=bash";
