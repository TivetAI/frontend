...
import * as components from "@tivet-gg/components/mdx";
		...
		<>
			...
			>
				<Button
					onClick={() => {
						document
							.getElementById("build-with-tivet")
				...
				<motion.div>
					<CardHeader>
						...
						<CardDescription>
							...
							Tivet can help you build your next project.
						</CardDescription>
					</CardHeader>
					<CardContent>
						<motion.div
			...
			>
				<motion.div>
					<CardHeader>
						<CardTitle>Build with Tivet</CardTitle>
						<CardDescription>
						...
						<div className="flex items-center justify-center">
							...
							>
								<motion.a
									...
									href="https://tivet.gg/docs?utm_source=hub"
									target="_blank"
									rel="noreferrer"
								>
									More
