...
import { Icon, faExternalLinkAlt, faSparkle } from "@tivet-gg/icons";
			...
			<div>
				<Picture className="rounded-md border my-4 h-[200px] w-full block overflow-hidden">
					...
					<PictureImage
						...
						src={`https://tivet.gg/${images[0].url}`}
						alt={"Changelog entry"}
					/>
				</Picture>
				...
				<p className="text-xs mt-1 text-muted-foreground">
					...
					<a
						...
						href={`https://tivet.gg/changelog/${slug}`}
						target="_blank"
						rel="noreferrer"
					>
					...
					<div className="flex gap-2 items-center">
						...
						>
							<Avatar className="size-8">
								...
								<AvatarImage
									src={`https://tivet.gg/${authors[0].avatar.url}`}
									alt={authors[0].name}
								/>
							</Avatar>
							<div className="ml-2">
