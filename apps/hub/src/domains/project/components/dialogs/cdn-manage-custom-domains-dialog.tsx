...
import { Icon, faInfoCircle, faPlus, faTrash } from "@tivet-gg/icons";
...
const VARIANT_MAP = {
	[Tivet.cloud.CdnNamespaceDomainVerificationStatus.Active]: null,
	[Tivet.cloud.CdnNamespaceDomainVerificationStatus.Pending]:
		"secondary" as const,
	[Tivet.cloud.CdnNamespaceDomainVerificationStatus.Failed]:
		"destructive" as const,
};

interface DomainConfigRowProps extends Tivet.cloud.CdnNamespaceDomain {
	projectId: string;
