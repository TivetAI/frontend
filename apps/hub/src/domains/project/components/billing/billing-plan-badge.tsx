...
import { Badge, Skeleton } from "@tivet-gg/components";
import { useQuery, useSuspenseQuery } from "@tanstack/react-query";
import { useIntersectionObserver } from "usehooks-ts";
import { projectBillingQueryOptions } from "../../queries";

const BILLING_PLAN_LABELS = {
	[Tivet.ee.billing.Plan.Indie]: "Pro",
	[Tivet.ee.billing.Plan.Studio]: "Team",
	[Tivet.ee.billing.Plan.Trial]: "Free",
};

const BILLING_PLAN_COLORS = {
	[Tivet.ee.billing.Plan.Indie]: "default",
	[Tivet.ee.billing.Plan.Studio]: "default",
	[Tivet.ee.billing.Plan.Trial]: "secondary",
} as const;
