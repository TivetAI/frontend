...
type CdnEnvironmentAuthPasswordUser = Pick<
	Tivet.cloud.CdnNamespaceAuthUser,
	"user"
> & {
	password: string;
};
...
function computeUsersDiff(
	existingUsers: Tivet.cloud.CdnNamespaceAuthUser["user"][],
	...
	const remove: Tivet.cloud.CdnNamespaceAuthUser["user"][] = [];
...
interface UseCdnManageAuthUsersFormHandlerProps {
	...
	userList: Tivet.cloud.CdnNamespaceAuthUser[];
	onSuccess?: () => void;
}
