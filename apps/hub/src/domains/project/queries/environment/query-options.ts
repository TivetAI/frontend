...
export const projectEnvironmentQueryOptions = ({
	...
	return queryOptions({
		...
		queryFn: ({
			...
			tivetClient.cloud.games.namespaces.getGameNamespaceById(
				projectId,
				environmentId,
				{ abortSignal: signal },
			),
...
export const projectEnvironmentLobbyQueryOptions = (
	...
	return queryOptions({
		...
		queryFn: ({
			...
			tivetClient.cloud.games.namespaces.logs.getNamespaceLobby(
				projectId,
				environmentId,
				lobbyId,
				{ abortSignal: signal },
...
export const projectEnvironmentTokenPublicQueryOptions = ({
	...
	return queryOptions({
		...
		queryFn: ({
			...
			tivetClient.cloud.games.namespaces.createGameNamespaceTokenPublic(
				projectId,
				environmentId,
				{ abortSignal: signal },
			),
...
export const projectEnvironmentLogsLobbiesQueryOptions = ({
	...
	return queryOptions({
		...
		queryFn: ({
			...
			tivetClient.cloud.games.namespaces.logs.listNamespaceLobbies(
				projectId,
				environmentId,
				{},
				{ abortSignal: signal },
...
export const projectEnvironmentLogsLobbyLogsQueryOptions = (
	{
		...
		projectId: string;
		lobbyId: string;
	} & Tivet.cloud.games.GetLobbyLogsRequest,
	...
	return queryOptions({
		...
		queryFn: async ({
			...
			const response =
				await tivetClient.cloud.games.matchmaker.getLobbyLogs(
					projectId,
					lobbyId,
					{
						stream: stream as Tivet.cloud.games.LogStream,
					},
					{ abortSignal: signal },
				);
			return {
...
export const projectEnvironmentLobbiesLiveQueryOptions = ({
	...
	return queryOptions({
		...
		queryFn: async ({
			...
			tivetClient.cloud.games.namespaces.analytics.getAnalyticsMatchmakerLive(
				projectId,
				environmentId,
				{ abortSignal: signal },
			),
