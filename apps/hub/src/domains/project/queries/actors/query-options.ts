...
export const projectActorsQueryOptions = ({
	...
	return infiniteQueryOptions({
		...
		meta: {
			updateCache: (
				data: InfiniteData<Tivet.actor.ListActorsResponse>,
				client,
			) => {
...
export const actorLogsQueryOptions = (
	...
	return queryOptions({
		...
		queryFn: async ({
			...
			const response = await tivetClient.actor.logs.get(
				actorId,
				{
					project,
					environment,
					stream: stream as Tivet.actor.LogStream,
...
export const actorErrorsQueryOptions = ({
	...
	return queryOptions({
		...actorLogsQueryOptions({
			...
			environmentNameId,
			actorId,
			stream: Tivet.actor.LogStream.StdErr,
		}),
...
export const actorBuildTagsQueryOptions = ({
	...
	return queryOptions({
		...
		queryFn: async ({
			...
			const response = await tivetClient.servers.builds.list(
				projectId,
				environmentId,
...
export const actorRegionsQueryOptions = ({
	...
	return queryOptions({
		...
		queryFn: ({
			...
			tivetClient.actor.regions.list(
				{ project, environment },
				{
					abortSignal,
				},
...
export const actorManagerUrlQueryOptions = ({
	...
	return queryOptions({
		...
		queryFn: async ({
			...
			const response = await tivetClient.actor.list(
				{
					project,
					environment,
