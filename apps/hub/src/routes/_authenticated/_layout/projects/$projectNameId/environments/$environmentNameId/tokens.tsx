...
function DevelopmentTokenCard() {
	...
	return (
		<DocsCard
			...
			href="https://tivet.gg/docs/general/concepts/dev-tokens"
		>
			<Text>
			...
			<CopyArea
				value={`tivet token create dev -n ${environment.nameId}`}
			/>
		</DocsCard>
	);
}
...
function PublicTokenCard() {
	return (
		<>
			<DocsCard
				title="Public token"
				href="https://tivet.gg/docs/general/concepts/handling-project-tokens#public-environment-tokens"
				footer={
					<Button asChild>
